            ...
            <div class="wish-item">
                ...
                <div class="wish-data">
                    ...
                    <span class="attend-status">
                        <img src="http://localhost/undangan_jawa/wp-content/assets/icon/${ucapanItem.kehadiran == 1 ? '' : 'tidak'}hadir.svg">
                    </span>
                    </div>
        ...
        $("#wishes-box").prepend(`
            <div class="wish-item">
                ...
                <div class="wish-data">
                    ...
                    <span>${nama}</span>
                    <span class="attend-status">
                        <img src="http://localhost/undangan_jawa/wp-content/assets/icon/${kehadiran == 1 ? '' : 'tidak'}hadir.svg">
                    </span>
                    </div>
